...
function installAgentSkill(flags = {}) {
  ...
  try {
    ...
    if (!existed) console.log(C.dim("  \u270e guía de KontrolIA Bots instalada para tu agente  \u2192  ~/.claude/skills/forja/"));
...
async function cmdInit(flags = {}) {
  ...
  try {
    ...
    if (!key && eventCode) {
      ...
      // con `forjabot suscribir`). Quien ya tiene KontrolIA Bots+ pasa --key; código de evento pasa --codigo.
